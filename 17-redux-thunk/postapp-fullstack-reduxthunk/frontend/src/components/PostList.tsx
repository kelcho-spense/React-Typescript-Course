...
import { fetchPostsThunk, deletePostThunk, updatePostThunk } from '../features/posts/redux/postSlice';
...
const PostList = () => {
    ...
    const saveEdit = () => {
        if (editingId) {
            dispatch(updatePostThunk({ id: editingId, post: { title: editTitle.trim(), body: editBody.trim() } }));
            setEditingId(null);
        }
    };
                        ...
                        {editingId === post._id ? (
                            ...
                            <>
                                ...
                                <div className="flex justify-between mt-4">
                                    ...
                                    <button
                                        className="p-2 text-red-600 hover:text-red-800"
                                        onClick={() => dispatch(deletePostThunk(post._id))}
                                    >
                                        <Trash2 size={20} />
                                    </button>
                                </div>
